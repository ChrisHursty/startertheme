...
if ( ! function_exists( 'startertheme_widgets_init' ) ) {
	/**
	...
	function startertheme_widgets_init() {
		...
		register_sidebar( array(
			'name'          => __( 'Left Sidebar', 'startertheme' ),
			'id'            => 'left-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Hero Slider', 'startertheme' ),
			'id'            => 'hero',
		...
		register_sidebar( array(
			'name'          => __( 'Hero Static', 'startertheme' ),
			'id'            => 'statichero',
		...
		register_sidebar( array(
			'name'          => __( 'Footer Full', 'startertheme' ),
			'id'            => 'footerfull',
...
} // endif function_exists( 'startertheme_widgets_init' ).
